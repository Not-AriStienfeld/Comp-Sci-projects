public class pawn extends Piece{
	...
	public boolean isValidMove(Location from, Location to, Piece[][] board) {
		...
		if(/*first move*/fromX==toX&&(fromX==1||fromX==7)
				&&(toY==3||toY==5)
				&&board[fromX][toY]==null||/*regular movement*/
				(fromX==toX&&(fromX==1
				||fromX==7)&&board[fromX][toY]
						==null&&fromY==toY+1 /*capturing*/
						||(fromX!=toX&&
						validMove((int) fromX, (int) fromY, board)
						&&(fromY==toY+1
